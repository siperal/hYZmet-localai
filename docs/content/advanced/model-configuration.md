...
This is a known limitation being tracked in issue [#8562](https://github.com/siperal/hYZmet-localai/issues/8562). A future implementation may provide a runtime toggle or custom logic to reconcile auto-fit with threshold-based unloading.
